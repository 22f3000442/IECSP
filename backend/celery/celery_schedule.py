...
def setup_periodic_tasks(sender, **kwargs):
    # every 10 seconds
    sender.add_periodic_task(10.0, test.s('students@gmail') )

    # daily message at 6:55 pm, everyday
    #sender.add_periodic_task(crontab(hour=18, minute=55), email_reminder.s('influencer@gmail', 'reminder to login', '<h1> hello everyone </h1>'), name='daily reminder' )
